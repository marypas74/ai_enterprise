 ...
 * `withBody=true` adds `content-type: application/json` (needed for POST/PUT/PATCH with JSON body).
 * Default is false — no content-type — which is correct for DELETE/GET and POST without body.
 */
