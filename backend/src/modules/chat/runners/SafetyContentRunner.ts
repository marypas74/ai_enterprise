/**
 * SafetyContentRunner — DEBT-83-G
 *
 * Extracted from completions.ts as part of the T6 refactor.
 *
 * Handles:
 * 1. Content safety check (AI Act GAP-10)
 * 2. Chat mode detection (brainstorm / RAG / free)
 * 3. System prompt injection per mode (brainstorm, RAG, free+AgentChain)
 * 4. Document format detection + doc-gen prompt injection in brainstorm mode
 *
...
export interface SafetyContentOptions {
...
/**
 * Check content safety and run fast_reply hook.
 * Returns safetyResult and shortCircuit flag.
 */
